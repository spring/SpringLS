 ...
 * @author hoijui
 */
@SupportedCommand("GETACCOUNTACCESS")
public class GetAccountAccessCommandProcessor extends AbstractCommandProcessor {

	public GetAccountAccessCommandProcessor() {
